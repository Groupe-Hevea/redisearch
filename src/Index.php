...
class Index
{
     ...
     * @return void
     */
    public function addMany(array $documents): void
    {
        $result = null;
        ...
        if (null !== $result) {
            $this->client->validateRawCommandResults($result, 'PIPE', [$this->getIndexName(), '*MANY']);
        }
    }
    ...
    {
        return (new Query($this->client, $this->getIndexName()));
    }
